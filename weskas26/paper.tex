...
The above geometric argument is extensible to a formal proof of optimality in terms of horizontal data movement for general $n$%
...
The existence of both 2D and 3D algorithms points to a discrete trade-off space between communication- and memory-optimality,
...
a lower bound of $n/p$ data movement in $1$ superstep again emerges-- even for higher-dimensional FFTs~\cite{valiant90}.
